...
for year in years:
    url = 'https://www.billboard.com/charts/year-end/' + year + '/top-billboard-200-albums'
    response = get(url)
    ...
    for row in rows:
        ...
        album = row.find('div', {'class': 'ye-chart-item__title'}).text.strip()
...
print(df)
df.to_csv('2005-2018top200albums.csv')
