...
columns = ['Artist', 'Song', 'Duration(ms)', 'Year', 'danceability', 'energy', 'key', 'loudness', 'speechiness', 'acousticness', 'instrumentalness', 'liveness', 'valence', 'tempo']
...
for index, row in top100.iterrows():
	...
	# 	break
print(df)
df.to_csv('songDataTop100ByYear.csv')
